...
train_avglinksize = list(np.array(p.read_table('train.tsv'))[:,5])
test_avglinksize = list(np.array(p.read_table('test.tsv'))[:,5])
...
#log = ensemble.gradient_boosting( #AdaBoostClassifier()
